...
function(a, b) {
	...
	c.prototype = {
		...
		search: function(a) {
			...
			else if (b._isSearchActivated()) for (e = 0; e < b._activeArray.length; e++) b._activeArray[e]._filterOut();
		...
		_makeSubarrays: function() {
			...
			for (c = 0; c < a._mainArray.length; c++) if ("object" == typeof a._mainArray[c]._category) for (var d = a._mainArray[c]._category.length, e = 0; e < d; e++) b[a._mainArray[c]._category[e] - 1].push(a._mainArray[c]);
	...
	var d = {
		...
		_filterIn: function(a) {
			...
			b(c).removeClass("filteredOut"), c._filteringIn = !0, c._lastPos = a, c.css("pointer-events", "auto"), d.transform += " translate3d(" + a.left * 1.1666666666666667 + "px," + a.top + "px, 0)", c.css(d)
		}
	}
}(this, jQuery);